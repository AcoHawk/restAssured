...
public class P02_SpartanDeserilizationPOJO extends SpartansTestBase {

    @DisplayName("GET SINGLE SPARTAN - DESTERILIZATION TO POJO USING SPARTAN CLASS")
    @Test
    public void test1() {
        ...
        //Desterilization to convert the JSON "data" object to Spartan POJO
    ...
    @DisplayName("GET SINGLE SPARTAN - DESTERILIZATION TO LIST OF SPARTANS")
    @Test
    public void test3() {
        Response response = given()
                .accept(ContentType.JSON)
